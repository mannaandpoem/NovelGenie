...
---
# 输出要求
- 章节标题: 使用“## 第x章 章节名称”作为本章节标题，不再使用其他小标题。
- 章节长度: 请生成完整的正文内容，不少于 {section_word_count} 字。
- 叙事方式：正文中应以场景化、叙事化和对话化的方式呈现内容。减少总结性描述，通过场景细节、人物动作、语言和心理活动展现故事，让读者在体验中理解情节与人物。
- 具体描写：注重具体描写，避免出现纯概括叙述。将抽象的概念转化为可感知的情境细节。
